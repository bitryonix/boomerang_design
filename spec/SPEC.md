...
- [5. Security And Timing Model](#5-security-and-timing-model)
- [6. Actors And State](#6-actors-and-state)
  - [6.1 Per-Peer Long-Lived State](#61-per-peer-long-lived-state)
  - [6.2 Shared State](#62-shared-state)
- [7. Cryptographic Objects](#7-cryptographic-objects)
  - [7.1 Key Classes](#71-key-classes)
  - [7.2 Doxing Material](#72-doxing-material)
  - [7.3 Encryption And Serialization](#73-encryption-and-serialization)
- [8. Descriptor](#8-descriptor)
  - [8.1 Overview](#81-overview)
  - [8.2 Descriptor Requirements](#82-descriptor-requirements)
- [9. Setup Protocol](#9-setup-protocol)
  - [9.1 Setup Preconditions](#91-setup-preconditions)
  - [9.2 SAR Registration](#92-sar-registration)
  - [9.3 Normal-Key And Boomlet Initialization](#93-normal-key-and-boomlet-initialization)
  - [9.4 ST Pairing And Duress-Consent Enrollment](#94-st-pairing-and-duress-consent-enrollment)
  - [9.5 Peer Identity Exchange And Shared-Parameter Agreement](#95-peer-identity-exchange-and-shared-parameter-agreement)
  - [9.6 WT-Mediated Setup Finalization](#96-wt-mediated-setup-finalization)
  - [9.7 Boomletwo Backup](#97-boomletwo-backup)
  - [9.8 Setup Success Conditions](#98-setup-success-conditions)
- [10. Withdrawal Protocol](#10-withdrawal-protocol)
  - [10.1 Preconditions](#101-preconditions)
  - [10.2 Initiator Approval](#102-initiator-approval)
  - [10.3 Non-Initiator Review And Approval](#103-non-initiator-review-and-approval)
  - [10.4 Commitment Phase](#104-commitment-phase)
  - [10.5 Digging Game](#105-digging-game)
  - [10.6 Counter Advancement](#106-counter-advancement)
  - [10.7 Hydration And Signing Readiness](#107-hydration-and-signing-readiness)
  - [10.8 Final Signing](#108-final-signing)
  - [10.9 WT Aggregation And Broadcast](#109-wt-aggregation-and-broadcast)
- [11. Duress Signaling](#11-duress-signaling)
  - [11.1 Scope](#111-scope)
  - [11.2 Consent Pattern](#112-consent-pattern)
  - [11.3 Duress Challenges](#113-duress-challenges)
  - [11.4 Duress Placeholder Rules](#114-duress-placeholder-rules)
  - [11.5 SAR Handling](#115-sar-handling)
- [12. Freshness, Replay Resistance, And Binding](#12-freshness-replay-resistance-and-binding)
- [13. Failure Behavior](#13-failure-behavior)
- [14. Security Considerations](#14-security-considerations)
- [15. Canonicality And Companion Documents](#15-canonicality-and-companion-documents)
- [16. TODO For A Complete RFC-Style Specification](#16-todo-for-a-complete-rfc-style-specification)
