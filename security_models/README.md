...
-  **WT and SAR remain available and SAR protects user information.** 
- **Peers have a secure out-of-band channel** during the setup ceremony.
...
**Goals**
- Exfiltrate key material, duress consent sets, or allow deterministic withdrawals under coercion by implanting backdoors in Boomlet applets, secure element firmware, ST firmware, Iso/Niso build pipeline, or cryptographic libraries.
...
**Goals**
- Confiscation funds by compelling parties involved to disclose keys.
- Freezing funds by compelling parties involved to stop responding.
- Use legal pressure or executive force to prevent SAR action or to obtain PII.
...
**Constraints**
- Jurisdiction-dependent; may be constrained by due process, technical protections, organizational policies and multi-jurisdiction geographic dispersion.

### Persona F: Opportunistic thief / “evil maid” (short physical access)

**Goals**
- Create latent compromise for future theft via stealing or swapping devices (ST/Boomlet/phone), implanting malware on Niso/Iso, capturing mnemonics/backups.
...
- the attacker cannot observe the user when he is entering the consent set without him finding out,
...
Classification below is based on combined **custody impact, safety impact, and privacy sensitivity** rather than on a pure information-security confidentiality label.
...
| Doxing data (static + dynamic)                 | **Critical safety-sensitive PII** | Compromise enables targeting, harm, and weakening of duress protection    |
...
| Attacker compels user to reveal doxing_password/doxing_key to weaken rescue                                                                                                                                                               | Human; phone; SAR                                                                 | Rescue weakening; PII misuse                                                          | Split doxing secret; store part in Boomlet; SAR requires additional factor;                                                                   | T-DURESS-04 / R-22                     |
...
| SAR processing/timing differences around duress placeholder handling                                                                                                                                                                     | WT↔SAR channel; SAR processing                                                    | Attacker infers duress handling occurred; escalates violence                          | Constant-time processing where feasible; delay equalization; minimize distinguishable operational side effects                                 | T-DURESS-05 / R-12, R-06               |
...
| Phishing user into registering wrong SAR(s) or revealing SAR association                                                                                                                                                                  | Phone setup; SAR IDs selection                                                    | Duress compromised; PII leak                                                          | Pinned SAR public keys; signed SAR directory; authenticated directory checks; redundancy                                                       | T-SAR-05 / R-06                        |
...
|:-------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------|:----------------------------------------------------------------------------------------------------------|:------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------------------|:------------------------------------------------------------------|:-------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Bitcoin funds (UTXO) locked in Boomerang Taproot output            | Integrity (only intended spend), Availability (recoverability), Safety (reduce coercion success)  | Coercer forces withdrawal; attacker tampers PSBT outputs; insider waits for late-stage normal script.     | T-HUM-01, T-TAMP-01, T-INS-01, T-PHYS-01              | Late-stage low-threshold scripts; weak governance and rollover discipline; insufficient independent PSBT verification. | Financial catastrophic; safety high; reputational high.                         | High-value target; complex human processes; adversarial pressure. | High                     | Require independent PSBT verification on dedicated operator hardware; keep ST focused on tx_id continuity; enforce rollover monitoring; governance/legal controls; incident response. |
| Normal key mnemonic & passphrase (per peer)                        | Confidentiality; Integrity of derivation; Availability (backup)                                   | Phishing or theft of mnemonic; compromised Iso during signing; insider theft.                             | T-HUM-02, T-ISO-01, T-KEY-01, T-UPDATE-01             | Weak passphrases; insecure storage; unvetted updates; poor air-gap.                                              | Financial high (esp. in deterministic regime); compliance high.                 | Humans handle secrets; common phishing tactics.                   | High                     | Shamir-split backups; hardened offline environment; secure update process; training.                                                                                 |
...
| Duress consent set (Boomlet-stored; user-memorized)                | Confidentiality; Usability under stress; Integrity of evaluation                                  | Attacker learns consent pattern via observation or ST compromise.                                          | T-SIDE-01, T-HUM-01, T-EOP-02                         | Insufficient physical shielding; compromised ST; repeated withdrawals in insecure environments.                 | Safety catastrophic; financial high (coercion success).                         | Coercion scenarios include surveillance; UI is observable.        | High                     | Shielded/private environments; UI hardening; ST assurance; training.                                                                                             |
| Doxing data (static + dynamic) and doxing key material             | Confidentiality; Integrity (rescue accuracy); Availability (reach SAR)                            | SAR breach; brute-force doxing key; phone compromise; legal compulsion.                                   | T-INFO-01, T-CRYPTO-03, T-PHONE-01, T-LEGAL-01        | Password-derived key without KDF/salt; SAR logging/retention; phone insecure.                                   | Safety catastrophic; privacy catastrophic; legal high.                           | Online service exposure; common breaches.                         | High                     | Argon2id/scrypt; per-user salt stored with the record; minimization/retention; HSM; mobile hardening; policy-appropriate SAR redundancy.                      |
...
| SAR service (duress detection + rescue ops)                        | Safety effectiveness; Confidentiality of PII; Availability                                        | SAR outage; insider misuse; legal coercion.                                                               | T-DOS-02, T-HUM-04, T-LEGAL-01                         | Jurisdiction dependency; PII retention; insufficient audited procedures.                                        | Safety catastrophic; legal high.                                                | Online exposure; political/legal variability.                     | High                     | Strict governance; audited procedures; HSM keys; retention limits; policy-appropriate redundancy.                                                               |
...
**Boomlet**
- Secure element selection and evaluation; anti-rollback counters; strict parsing; signed applets; minimal command surface; treat applet binary as immutable post-provisioning absent full reprovisioning.
...
**SAR**
- PII minimization; retention limits; HSM; audited access; redundant on-call.